...
function PiikkiUtil()
{
	...
	{
		$("#number").text("Onnistuneet piikkaukset tällä kertaa: " + successfulPiikkaukset + "/" + triedPiikkaukset);
	...
	this.buildItemPage = function()
	{
		...
		this.getItems(function(){
			...
			code += "<div id=\"login\" class=\"login\"><a href='user.html?id="+piikki.currentUserId+"'>Omat tiedot</a></div>";
